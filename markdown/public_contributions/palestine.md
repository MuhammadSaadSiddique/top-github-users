...
The `public contributions` by users in Palestine on `2024/4/15 8:30 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
