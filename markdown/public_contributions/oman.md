...
The `public contributions` by users in Oman on `2023/12/11 9:00 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
...
<table>
	...
	<tr>
		<td>439</td>
		<td>
			<a href="https://github.com/dasukacleaning">
				<img src="https://avatars.githubusercontent.com/u/153498027?s=72&v=4" width="24" alt="Avatar of dasukacleaning"> dasukacleaning
			</a><br/>
			Dasuka Cleaning
		</td>
		<td>Dasuka Cleaning </td>
		<td>No Twitter Username</td>
		<td>Dragon Mart 02 Office F-D-47-22 Hatta Oman Street Al Warsan International City Dubai UAE.</td>
		<td>1</td>
	</tr>
	<tr>
		<td>440</td>
