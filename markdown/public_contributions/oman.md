...
The `public contributions` by users in Oman on `2024/5/19 8:59 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
...
<table>
	...
	<tr>
		...
		<td>Full Stack Engineer -<br/>Computer<br/>Science<br/>Graduate<br/>From<br/>University<br/>Of<br/>South<br/>Florida<br/></td>
		<td>No Twitter Username</td>
		<td>Muscat, Oman</td>
		<td>36</td>
	</tr>
