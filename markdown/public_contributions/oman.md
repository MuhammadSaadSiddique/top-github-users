...
The `public contributions` by users in Oman on `2026/5/31 10:00 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/tahmooress">
				<img src="https://avatars.githubusercontent.com/u/48440984?s=72&v=4" width="24" alt="Avatar of tahmooress"> tahmooress
			</a><br/>
			tahmoores nassaj
		</td>
		<td>No Company</td>
