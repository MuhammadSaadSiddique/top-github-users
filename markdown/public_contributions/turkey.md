...
The `public contributions` by users in Turkey on `2025/6/30 1:32 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
