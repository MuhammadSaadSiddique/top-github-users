...
The `public contributions` by users in Turkey on `2023/10/20 1:20 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
