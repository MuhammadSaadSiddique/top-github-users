...
The `public contributions` by users in Saudi Arabia on `2024/11/30 8:39 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
...
<table>
	...
	<tr>
		<td>156</td>
		<td>
			<a href="https://github.com/ibrahimAlbadawi">
				<img src="https://avatars.githubusercontent.com/u/140857058?s=72&v=4" width="24" alt="Avatar of ibrahimAlbadawi"> ibrahimAlbadawi
			</a><br/>
			Ibrahim Albadawi
		</td>
		<td>No Company</td>
