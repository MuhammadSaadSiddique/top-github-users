...
The `public contributions` and `private contributions` by users in Bangladesh on `2026/8/4 9:16 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/swadh1n">swadh1n</a></td>
		<td>Dhaka,Bangladesh.</td>
		<td>2985</td>
		<td>5101</td>
	</tr>
