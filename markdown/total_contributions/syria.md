...
The `public contributions` and `private contributions` by users in Syria on `2025/3/22 8:55 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
...
<table>
	...
	<tr>
		<td>500</td>
		<td>
			<a href="https://github.com/aabousika">
				<img src="https://avatars.githubusercontent.com/u/181503045?s=72&v=4" width="24" alt="Avatar of aabousika"> aabousika
			</a><br/>
			angel abou sika
		</td>
		<td>No Company</td>
