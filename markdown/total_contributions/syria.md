...
The `public contributions` and `private contributions` by users in Syria on `2023/11/20 1:24 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
