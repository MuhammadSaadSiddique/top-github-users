...
The `public contributions` and `private contributions` by users in Syria on `2023/12/14 8:41 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
