...
The `public contributions` and `private contributions` by users in Syria on `2023/12/17 8:30 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
