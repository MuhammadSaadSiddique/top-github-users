...
The `public contributions` and `private contributions` by users in Syria on `2024/9/18 8:47 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
