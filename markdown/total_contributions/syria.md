...
The `public contributions` and `private contributions` by users in Syria on `2025/9/21 1:22 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ezzatzaino">
				<img src="https://avatars.githubusercontent.com/u/71769838?s=72&v=4" width="24" alt="Avatar of ezzatzaino"> ezzatzaino
			</a><br/>
			Ezzat Zaino
		</td>
		<td>No Company</td>
