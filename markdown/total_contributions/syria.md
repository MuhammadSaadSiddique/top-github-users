...
The `public contributions` and `private contributions` by users in Syria on `2025/10/6 1:17 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/alimou1sa">
				<img src="https://avatars.githubusercontent.com/u/174483428?s=72&v=4" width="24" alt="Avatar of alimou1sa"> alimou1sa
			</a><br/>
			Dev.Ali Mousa
		</td>
		<td>No Company</td>
