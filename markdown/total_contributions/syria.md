...
The `public contributions` and `private contributions` by users in Syria on `2024/4/12 8:45 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
