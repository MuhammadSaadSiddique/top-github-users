...
The `public contributions` and `private contributions` by users in Syria on `2024/12/19 1:15 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
