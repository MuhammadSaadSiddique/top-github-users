...
The `public contributions` and `private contributions` by users in Syria on `2024/8/16 9:01 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
