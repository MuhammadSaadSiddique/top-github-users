...
The `public contributions` and `private contributions` by users in Syria on `2025/4/28 9:07 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
...
<table>
	...
	<tr>
		<td>523</td>
		<td>
			<a href="https://github.com/KaramFarah">
				<img src="https://avatars.githubusercontent.com/u/106422033?s=72&v=4" width="24" alt="Avatar of KaramFarah"> KaramFarah
			</a><br/>
			No Name
		</td>
		<td>No Company</td>
