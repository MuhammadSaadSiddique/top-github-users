...
The `public contributions` and `private contributions` by users in Syria on `2023/11/28 1:23 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/AmjadSharaf">
				<img src="https://avatars.githubusercontent.com/u/147296610?s=72&v=4" width="24" alt="Avatar of AmjadSharaf"> AmjadSharaf
			</a><br/>
			Amjad Sharaf
		</td>
		<td># </td>
