...
The `public contributions` and `private contributions` by users in Syria on `2025/11/11 8:43 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
...
<table>
	...
	<tr>
		<td>635</td>
		<td>
			<a href="https://github.com/rizkalhamdan">
				<img src="https://avatars.githubusercontent.com/u/230568132?s=72&v=4" width="24" alt="Avatar of rizkalhamdan"> rizkalhamdan
			</a><br/>
			RIZK
		</td>
		<td>Cadoa </td>
