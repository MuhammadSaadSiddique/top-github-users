...
The `public contributions` and `private contributions` by users in Syria on `2023/10/19 1:18 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
