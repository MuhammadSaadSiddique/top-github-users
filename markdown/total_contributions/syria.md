...
The `public contributions` and `private contributions` by users in Syria on `2025/10/16 1:18 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
