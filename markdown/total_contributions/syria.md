...
The `public contributions` and `private contributions` by users in Syria on `2025/12/17 9:20 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/HeavenFandi">
				<img src="https://avatars.githubusercontent.com/u/166942804?s=72&v=4" width="24" alt="Avatar of HeavenFandi"> HeavenFandi
			</a><br/>
			Heaven Fandi
		</td>
		<td>No Company</td>
