...
The `public contributions` and `private contributions` by users in Saudi Arabia on `2023/12/24 2:00 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
