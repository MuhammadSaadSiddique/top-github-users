...
The `public contributions` and `private contributions` by users in Remote on `2025/1/19 9:20 PM UTC`. This list contains users from `Remote` and cities.
...
<table>
	...
	<tr>
		...
		<td><a href="https://twitter.com/minikin">minikin</a></td>
		<td>Berlin, Remote</td>
		<td>875</td>
		<td>1141</td>
	</tr>
