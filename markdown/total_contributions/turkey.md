...
The `public contributions` and `private contributions` by users in Turkey on `2024/5/21 8:52 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
