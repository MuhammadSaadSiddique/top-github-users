...
The `public contributions` and `private contributions` by users in Turkey on `2026/3/5 9:13 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
