...
The `public contributions` and `private contributions` by users in Turkey on `2025/3/16 1:22 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
