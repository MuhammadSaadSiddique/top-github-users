...
The `public contributions` and `private contributions` by users in Turkey on `2024/6/7 9:16 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
