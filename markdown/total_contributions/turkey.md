...
The `public contributions` and `private contributions` by users in Turkey on `2023/11/29 1:24 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
