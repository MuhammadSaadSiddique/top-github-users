...
The `public contributions` and `private contributions` by users in Turkey on `2024/8/16 9:19 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
