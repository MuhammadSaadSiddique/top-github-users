...
The `public contributions` and `private contributions` by users in Turkey on `2025/11/1 8:25 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
