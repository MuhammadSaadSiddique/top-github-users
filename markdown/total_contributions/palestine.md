...
The `public contributions` and `private contributions` by users in Palestine on `2023/12/19 1:52 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
