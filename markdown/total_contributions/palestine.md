...
The `public contributions` and `private contributions` by users in Palestine on `2024/8/4 9:02 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
