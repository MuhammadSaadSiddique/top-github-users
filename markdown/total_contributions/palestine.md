...
The `public contributions` and `private contributions` by users in Palestine on `2024/7/16 9:14 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
