...
The `public contributions` and `private contributions` by users in Palestine on `2024/4/12 8:28 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
