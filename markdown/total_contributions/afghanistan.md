...
The `public contributions` and `private contributions` by users in Afghanistan on `2026/1/13 9:27 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
...
<table>
	...
	<tr>
		<td>513</td>
		<td>
			<a href="https://github.com/zaman-ramazani">
				<img src="https://avatars.githubusercontent.com/u/170423486?s=72&u=9af078f7abe6465d95ef8becdb9c672974408bbf&v=4" width="24" alt="Avatar of zaman-ramazani"> zaman-ramazani
			</a><br/>
			Zaman
		</td>
		<td>No Company</td>
