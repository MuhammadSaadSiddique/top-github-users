...
The `public contributions` and `private contributions` by users in Afghanistan on `2026/1/4 8:47 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Mustafa-Arghandiwal">
				<img src="https://avatars.githubusercontent.com/u/107584485?s=72&u=40b76fab641ec2e4db3c63f9d2e035aa1ef748de&v=4" width="24" alt="Avatar of Mustafa-Arghandiwal"> Mustafa-Arghandiwal
			</a><br/>
			Mustafa
		</td>
		<td>No Company</td>
