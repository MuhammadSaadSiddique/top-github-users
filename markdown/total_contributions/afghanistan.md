...
The `public contributions` and `private contributions` by users in Afghanistan on `2026/3/29 8:34 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.

There are `9 countries` and `46 cities` can be found [here](https://github.com/MuhammadSaadSiddique/top-github-users).

There are `930 users`  in Afghanistan. You need at least `2 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Farhadzafar">
				<img src="https://avatars.githubusercontent.com/u/146546972?s=72&u=209d01e8c2ec780859b02773a4724387baf29746&v=4" width="24" alt="Avatar of Farhadzafar"> Farhadzafar
			</a><br/>
			Farhad Ahmad Zafari
		</td>
		<td>No Company</td>
