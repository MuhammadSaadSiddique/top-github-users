...
The `public contributions` and `private contributions` by users in Afghanistan on `2025/4/22 8:54 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.

There are `9 countries` and `46 cities` can be found [here](https://github.com/MuhammadSaadSiddique/top-github-users).

There are `919 users`  in Afghanistan. You need at least `1 followers` to be on this list.
