...
The `public contributions` and `private contributions` by users in Afghanistan on `2024/7/26 8:36 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
