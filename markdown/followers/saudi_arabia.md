...
The `number of followers` of users in Saudi Arabia on `2024/6/22 9:25 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
