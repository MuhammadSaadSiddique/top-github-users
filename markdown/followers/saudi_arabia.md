...
The `number of followers` of users in Saudi Arabia on `2025/2/28 1:14 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
