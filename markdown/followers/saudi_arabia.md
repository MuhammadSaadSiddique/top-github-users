...
The `number of followers` of users in Saudi Arabia on `2023/12/22 8:18 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
