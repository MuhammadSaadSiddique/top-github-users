...
The `number of followers` of users in Saudi Arabia on `2024/11/11 9:22 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
