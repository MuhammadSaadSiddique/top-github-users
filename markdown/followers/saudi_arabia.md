...
The `number of followers` of users in Saudi Arabia on `2026/3/12 1:56 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
