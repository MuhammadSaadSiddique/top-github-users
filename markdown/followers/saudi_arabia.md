...
The `number of followers` of users in Saudi Arabia on `2024/3/18 12:57 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
