...
The `number of followers` of users in Saudi Arabia on `2025/1/19 8:21 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
