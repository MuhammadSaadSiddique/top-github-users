...
The `number of followers` of users in Saudi Arabia on `2026/6/11 3:40 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
