...
The `number of followers` of users in Saudi Arabia on `2026/7/16 9:56 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
