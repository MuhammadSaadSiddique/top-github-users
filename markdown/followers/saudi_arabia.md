...
The `number of followers` of users in Saudi Arabia on `2026/2/14 1:54 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
