...
The `number of followers` of users in Saudi Arabia on `2025/3/27 8:40 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
