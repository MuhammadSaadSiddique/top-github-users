...
The `number of followers` of users in Saudi Arabia on `2024/6/24 2:08 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
