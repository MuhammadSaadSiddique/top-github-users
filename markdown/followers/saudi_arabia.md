...
The `number of followers` of users in Saudi Arabia on `2024/2/21 8:31 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
