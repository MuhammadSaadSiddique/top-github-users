...
The `number of followers` of users in Saudi Arabia on `2023/10/26 1:18 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
