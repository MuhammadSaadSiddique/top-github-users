...
The `number of followers` of users in Saudi Arabia on `2024/2/1 8:29 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
