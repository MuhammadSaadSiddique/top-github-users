...
The `number of followers` of users in Saudi Arabia on `2023/12/28 8:55 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
