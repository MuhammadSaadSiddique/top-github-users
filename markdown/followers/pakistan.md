...
The `number of followers` of users in Pakistan on `2025/8/20 8:45 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
