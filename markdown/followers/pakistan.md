...
The `number of followers` of users in Pakistan on `2024/9/13 8:56 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
