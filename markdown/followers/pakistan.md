...
The `number of followers` of users in Pakistan on `2024/2/20 1:43 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
