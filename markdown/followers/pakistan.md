...
The `number of followers` of users in Pakistan on `2025/3/23 8:52 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
...
<table>
	...
	<tr>
		...
		<td><a href="https://twitter.com/zahid3819">zahid3819</a></td>
		<td>Lahore</td>
		<td>50</td>
	</tr>
	<tr>
