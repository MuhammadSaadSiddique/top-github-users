...
The `number of followers` of users in Pakistan on `2024/2/24 1:40 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
