...
The `number of followers` of users in Pakistan on `2024/1/15 1:02 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
