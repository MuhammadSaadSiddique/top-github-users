...
The `number of followers` of users in Pakistan on `2024/5/15 1:59 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
