...
The `number of followers` of users in Pakistan on `2025/3/22 8:23 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
