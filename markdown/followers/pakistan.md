...
The `number of followers` of users in Pakistan on `2024/9/28 8:37 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
