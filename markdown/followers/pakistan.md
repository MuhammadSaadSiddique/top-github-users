...
The `number of followers` of users in Pakistan on `2023/12/15 1:56 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
