...
The `number of followers` of users in Pakistan on `2025/3/2 9:23 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
