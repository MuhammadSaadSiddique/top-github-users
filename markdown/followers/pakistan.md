...
The `number of followers` of users in Pakistan on `2025/4/30 1:23 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
