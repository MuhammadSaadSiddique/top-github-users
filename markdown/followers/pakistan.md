...
The `number of followers` of users in Pakistan on `2026/1/1 8:50 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/syedamahamfahim">syedamahamfahim</a></td>
		<td>Karachi,Pakistan</td>
		<td>196</td>
	</tr>
	<tr>
