...
The `number of followers` of users in Pakistan on `2024/6/10 9:00 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
