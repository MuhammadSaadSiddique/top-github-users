...
The `number of followers` of users in Pakistan on `2024/4/17 8:19 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
