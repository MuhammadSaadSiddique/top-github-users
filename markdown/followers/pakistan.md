...
The `number of followers` of users in Pakistan on `2024/3/16 9:04 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
