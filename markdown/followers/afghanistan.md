...
The `number of followers` of users in Afghanistan on `2025/10/20 1:24 AM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
...
<table>
	...
	<tr>
		<td>514</td>
		<td>
			<a href="https://github.com/Olliyoung">
				<img src="https://avatars.githubusercontent.com/u/161157859?s=72&v=4" width="24" alt="Avatar of Olliyoung"> Olliyoung
			</a><br/>
			olliyoung
		</td>
		<td>No Company</td>
