...
The `number of followers` of users in Bangladesh on `2024/4/28 2:01 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
