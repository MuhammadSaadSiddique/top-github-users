...
The `number of followers` of users in Bangladesh on `2023/12/20 9:09 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
