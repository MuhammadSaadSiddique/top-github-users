...
The `number of followers` of users in Palestine on `2024/8/27 8:46 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
