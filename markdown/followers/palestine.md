...
The `number of followers` of users in Palestine on `2024/12/26 8:36 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
