...
The `number of followers` of users in Palestine on `2024/11/26 9:17 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
