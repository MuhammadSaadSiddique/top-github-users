...
The `number of followers` of users in Palestine on `2024/7/19 8:45 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
