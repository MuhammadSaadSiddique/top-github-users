...
The `number of followers` of users in Palestine on `2024/11/14 9:07 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
