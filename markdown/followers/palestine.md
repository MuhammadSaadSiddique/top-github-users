...
The `number of followers` of users in Palestine on `2024/7/27 1:03 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
