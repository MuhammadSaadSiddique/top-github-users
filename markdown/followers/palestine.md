...
The `number of followers` of users in Palestine on `2024/10/27 9:13 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
