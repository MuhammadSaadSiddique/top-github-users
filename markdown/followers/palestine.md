...
The `number of followers` of users in Palestine on `2024/9/12 8:22 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
