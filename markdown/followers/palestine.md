...
The `number of followers` of users in Palestine on `2024/7/22 2:15 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
