...
The `number of followers` of users in Palestine on `2024/8/25 1:10 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
