...
The `number of followers` of users in Palestine on `2024/11/11 9:04 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
