...
The `number of followers` of users in Palestine on `2024/12/15 1:23 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
