...
The `number of followers` of users in Palestine on `2024/11/21 9:00 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
