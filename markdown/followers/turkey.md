...
The `number of followers` of users in Turkey on `2024/6/14 8:34 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
