...
The `number of followers` of users in Turkey on `2023/12/14 8:51 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

There are `8 countries` and `46 cities` can be found [here](https://github.com/MuhammadSaadSiddique/top-github-users).

There are `982 users`  in Turkey. You need at least `117 followers` to be on this list.
