...
The `number of followers` of users in Turkey on `2026/2/8 9:12 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
