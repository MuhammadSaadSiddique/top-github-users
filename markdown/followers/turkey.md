...
The `number of followers` of users in Turkey on `2025/8/3 8:51 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

There are `9 countries` and `46 cities` can be found [here](https://github.com/MuhammadSaadSiddique/top-github-users).

There are `848 users`  in Turkey. You need at least `155 followers` to be on this list.
