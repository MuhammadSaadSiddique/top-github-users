...
The `number of followers` of users in Turkey on `2024/1/20 9:06 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
