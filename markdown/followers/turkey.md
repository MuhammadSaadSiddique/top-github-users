...
The `number of followers` of users in Turkey on `2024/1/22 9:13 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
