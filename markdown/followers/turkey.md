...
The `number of followers` of users in Turkey on `2024/7/26 2:10 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
