...
The `number of followers` of users in Turkey on `2024/7/27 8:32 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
