...
The `number of followers` of users in Turkey on `2024/6/10 2:09 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
...
<table>
	...
	<tr>
		...
		<td>@neuralailab, Previous @heviai @researchmenzies,<br/>@wickingdementia,<br/>@sdg-ai-lab<br/></td>
		<td>No Twitter Username</td>
		<td>Istanbul, Turkey</td>
		<td>157</td>
	</tr>
