...
The `number of followers` of users in Turkey on `2025/7/12 8:58 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

There are `9 countries` and `46 cities` can be found [here](https://github.com/MuhammadSaadSiddique/top-github-users).

There are `782 users`  in Turkey. You need at least `164 followers` to be on this list.
