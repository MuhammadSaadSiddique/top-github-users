...
The `number of followers` of users in Turkey on `2023/12/7 1:24 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

There are `8 countries` and `43 cities` can be found [here](https://github.com/MuhammadSaadSiddique/top-github-users).

There are `981 users`  in Turkey. You need at least `116 followers` to be on this list.
